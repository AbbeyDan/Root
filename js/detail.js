...
var detail = {
    ...
    navPosition:function(){
        var navTop = $('.detail-left').offset().top;
        $(window).scroll(function(){
            var scrollTop = $(window).scrollTop();
            if (scrollTop > navTop) {
                $('.detail-left').addClass('detail-position');
            } else {
                $('.detail-left').removeClass('detail-position');
            }
        })
    },
    refresh: function() {
    ...
    loginPart: function() {
        ...
        var wwwUrl = "//www." + baseUrl;
        var passportUrl = "//passport." + baseUrl;
